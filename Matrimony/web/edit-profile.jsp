                                ...
                                <form action="EditUsersServlet" method="post">
                                    <div class="seven columns">
                                        ...
                                        <dl class="tabs pill custom">
                                            <dd class="active"><a href="#looking-for">Information</a><!--<span class="notch"></span>--></dd>
                                        ...
                                        <ul class="tabs-content custom">
                                            ...
                                            <li class="active" id="looking-forTab">
                                                ...
                                                <div style="padding: 0 16px;">
                                                    Nick Name:<input type="text" name="name" value="${u.name}"  />
                                                </div>
                                                ...
                                                <div class="callout-speech-wrapp six columns">
                                                    <p>Birth Day:<input type="text" id="datepicker" name="birthday" value="${u.birthday}" class="inputbox" placeholder="Birth Day"/></p>
                                                </div>
                                            ...
                                            <li class="mySlider" id="my-photosTab">              
                                                ...
                                                <!--                                                <div class="twelve columns centered btn-carousel hide-for-small">
