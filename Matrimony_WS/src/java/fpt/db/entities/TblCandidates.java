...
@NamedQueries({
    ...
    @NamedQuery(name = "TblCandidates.findById", query = "SELECT t FROM TblCandidates t WHERE t.id = :id"),
    @NamedQuery(name = "TblCandidates.findByStatus", query = "SELECT t FROM TblCandidates t WHERE t.status = :status"),
    @NamedQuery(name = "TblCandidates.findByCreatedDate", query = "SELECT t FROM TblCandidates t WHERE t.createdDate = :createdDate")})
public class TblCandidates implements Serializable {
    ...
    public TblCandidates(Integer id) {
        this.id = id;
    }

    public TblCandidates(Integer id, int status, Date createdDate) {
        this.id = id;
        this.status = status;
    ...
    public String toString() {
        return "fpt.db.entities.TblCandidates[ id=" + id + " ]";
    }
